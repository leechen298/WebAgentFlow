# M10 · 10.1 — LearnedPath persistence

**Iteration window**: 2026-04-23 → 2026-04-25
**Branch**: `v0.1-local`（local-only，未推远端）
**Iteration record**: `docs/iterations/m10/10.1-learned-path-persistence/`
...
- `docs/iterations/m10/README.md`（M10 索引 + 六项交付物）
- `docs/iterations/m10/10.1-learned-path-persistence/`
...
- `docs/roadmap.md` M10 章节把 LearnedPath 那条改成 SHIPPED
...
```
93b2f85 docs(m10/iter-01): record verify-scenario evidence
...
1dba861 docs(m10): add iteration scaffolding, terminology, §10.7
```
