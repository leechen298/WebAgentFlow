...
| [11.3.6.6 · Runtime Eval Gate Failure Fixes](../11.3.6.6-runtime-eval-gate-failure-fixes/) | 修复 11.3.6.5 service-available rerun 暴露的 pending choice payload leak、planner selection execution 和 artifact redaction failures | ready_for_implementation |
...
11.3.6.6 已开为后续代码型 fix 迭代文档包，当前状态为 `ready_for_implementation`。
