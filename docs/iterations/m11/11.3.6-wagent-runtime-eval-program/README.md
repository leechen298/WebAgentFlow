...
| [11.3.6.4 · Planner-backed Choice Eval](../11.3.6.4-planner-backed-choice-eval/) | 覆盖 vague goal、planner-backed choice path 和 single-path bypass Planner 回归 | draft_for_review |
...
11.3.6.4 planner-backed choice eval 文档已开包，等待 design review。
