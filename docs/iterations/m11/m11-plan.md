...
| [11.3.5.4 · Parameterized Learning / Replay Slots](./11.3.5.4-parameterized-learning-replay-slots/) | 补 `item_name` 等业务 slot 抽取、学习填值、`value_slot` 参数绑定和 replay `slot_overrides`，支持学习 A 后按用户新输入执行 B | draft_docs |
