...
| [11.3.5.5 · ExecutionEvidence & TaskResultReporter Adapter](./11.3.5.5-execution-evidence-result-reporter-adapter/) | 新增 / 扩展执行证据 contract，runtime stop 前采集 DOM evidence，并把 replay result + page evidence 适配成保守结果回复 | draft_docs |
