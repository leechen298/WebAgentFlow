...
| [11.3.5.7 · Pending Choice & Minimal Active Task Ledger](./11.3.5.7-pending-choice-active-task-ledger/) | 多候选澄清、choice 私有映射、最小 active task 状态账本、pending 清理 / 过期和 cancel cleanup | draft_docs（待评审，未开始实现） |
