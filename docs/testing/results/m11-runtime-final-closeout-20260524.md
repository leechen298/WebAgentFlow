...
- M11.3 Interactive Chat Productization:
  ...
  product-test-site separation, schema-constrained intake, working runtime
...
- 11.3.5.6 chat `/items` closed loop:
  `docs/testing/results/m11-11.3.5.6-items-closed-loop-2026-05-21.md`.
...
External validation-site migration is intentionally out of scope for this
...
- External black-box validation-site migration as a separate track.
