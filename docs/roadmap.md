...
- **11.3.4 Conversation Intake Agent** — proposed; adds a schema-constrained
  ...
  It also requires conversation history detail to show whether each WAgent reply
  was generated by code or by an internal Agent, with redacted provider / model /
  raw LLM trace when an LLM was involved.
