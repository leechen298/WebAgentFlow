export default {
  ...
  learnedPaths: {
    ...
    replayTitle: 'Replay this path',
    replayUrl: 'Target URL',
    replayButton: 'Replay',
    replayLoading: 'Replaying...',
    replayError: 'Replay failed',
    replayStatus: 'Replay status',
    driftStatusLabel: 'Page drift',
    ...
    noSteps: 'No step logs',
    replayStatusSucceeded: 'Succeeded',
    replayStatusObserved: 'No actions, page observed',
    replayStatusDrifted: 'Page drift prevented replay',
    ...
    driftStatusPageMismatch: 'Page mismatch',
    driftStatusUnsupportedAction: 'Unsupported action',
  },
  autonomousHistory: {
    ...
    copiedId: 'Run ID copied to clipboard',
  ...
  conversationHistory: {
    title: 'Chat History',
    subtitle: 'View interactive chat session history, messages, events, and run evidence.',
    refresh: 'Refresh',
    ...
    colMode: 'Mode',
    colStatus: 'Status',
    colLastUserMsg: 'Last User Message',
    colLastAgentMsg: 'Last Agent Reply',
    colLearnedActions: 'Learned Actions',
    colEvents: 'Events',
    copyId: 'Copy ID',
    copiedId: 'Session ID copied to clipboard',
    viewDetail: 'View Detail',
    detailPageTitle: 'Session Detail',
    tabDebugTimeline: 'Debug Timeline',
    tabTranscript: 'Transcript',
    tabEvents: 'Events',
    tabLearnedActions: 'Learned Actions',
    tabEvidence: 'Replay / Learning Evidence',
    tabRawJson: 'Raw JSON',
    timelineDetails: 'Redacted Details',
    timelineEmpty: 'No readable debug timeline yet. Check Events or Raw JSON.',
    timelineStatus: {
      info: 'Info',
      waiting: 'Waiting',
      running: 'Running',
    ...
    copiedRawJson: 'Raw JSON copied to clipboard',
